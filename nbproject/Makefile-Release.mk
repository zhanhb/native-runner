...
${OBJECTDIR}/arguments_parser.o: arguments_parser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arguments_parser.o arguments_parser.cpp

${OBJECTDIR}/copy_stream_thread.o: copy_stream_thread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/copy_stream_thread.o copy_stream_thread.cpp

${OBJECTDIR}/io_util_md.o: io_util_md.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/io_util_md.o io_util_md.cpp

${OBJECTDIR}/judge_process.o: judge_process.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/judge_process.o judge_process.cpp
...
${OBJECTDIR}/platform.o: platform.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/platform.o platform.cpp
